...
// Step 1: What event do we want to use to create shapes:

// Step 2: Create an event handler to attacch to the event: 
...
const addShape = (ev) => {
    ...
    const circle= `
        <circle cx="${ev.offsetX}" cy="${ev.offsetY}" r="20" stroke="black" stroke-width="3" fill="red"></circle>' `;
